...
const ChangePasswordModal = (props) => {
  ...
  const formController = (e) => {
    ...
    if (
      ...
      dataForm.confirmPassword.trim() === dataForm.password.trim()
    ) {
      ...
      <ModalBody>
        <form id="changePassword" onSubmit={formController}>
          <div className="input-wrapper">
            ...
            <input id="passwordNew" type="password" name="pw" maxLength="30" />
            <div className="error">{error.password}</div>
          </div>
          <div className="input-wrapper">
            <label htmlFor="passwordCf">Confirm new password</label>
            <input
              id="passwordCf"
              type="password"
